...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--data_mode", help="use which database, [casia, vgg, ms1m, retina, ms1mr]",default='icartoonface', type=str)
    ...
    parser.add_argument("-t", "--target", help="verification targets", default='val', type=str)
